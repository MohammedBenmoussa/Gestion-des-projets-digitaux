...
{
ChefDeProjetServiceImpl chefservice=new ChefDeProjetServiceImpl();
chef=chefservice.unique(em);
}
%>
				...
				<div class="box-content bordered primary margin-bottom-20">
					<div class="profile-avatar">
						...
						<%
							...
							%>
							<img src="../tmpfiles/<%=chef.getAvatar() %>" width="200%" height="200%"/>
							<% 
							}
						%>
						<a href="../adminAccueil.jsp" class="btn btn-block btn-friend"><i class="fa fa-check-circle"></i> <%=chef.getPrivilige() %></a>
				...
				<div class="row">
					...
					<!-- /.col-md-12 -->
						...
						<div class="box-content card">
							...
							if(id==m.getIdCollaborateur() && m.getPrivilige().equalsIgnoreCase("Chef de projet"))
								{
							%>							
