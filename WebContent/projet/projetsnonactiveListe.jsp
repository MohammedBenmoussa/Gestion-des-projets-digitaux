...
<div class="fixed-navbar">
	...
	<div class="pull-left">
		...
		<h1 class="page-title">Liste des projets en attente</h1>
	</div>
			...
			<div class="row small-spacing">
				<div class="col-xs-12">
					<div class="box-content">
						<h4 class="box-title">Liste des projets en attente</h4>
						<table id="example" class="table table-striped table-bordered display" style="width:100%">
							...
							<tbody>
							 ...
							 <c:forEach var="user" items="${sessionScope.listenon}">
                			<tr>
		                    ...
		                    <td><c:out value="${user.getCoutEstime()}" /></td>
		                    <td><c:out value="${user.getBudget()}" /></td>
		                    <td style="text-align:center;"><c:out value="${user.getIdClient()}" /></td>
		                    <td><a href="../projetserv?id=<c:out value="${user.getId()}" />&type=update" style="color:black;" class="btn btn-success ">Activé</a></td>
		                    </c:if>
                			</tr>
                			</c:forEach>
							</tbody>
