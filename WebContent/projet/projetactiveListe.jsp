...
<div class="fixed-navbar">
	...
	<div class="pull-left">
		...
		<h1 class="page-title">Liste des projet validés</h1>
	</div>
			...
			<div class="row small-spacing">
				<div class="col-xs-12">
					<div class="box-content">
						<h4 class="box-title">Liste des projets Actives</h4>
						<table id="example" class="table table-striped table-bordered display" style="width:100%">
							...
							<c:forEach var="user" items="${sessionScope.listeactive}">
                			<tr>
