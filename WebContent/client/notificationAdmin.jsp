				...
				<div class="col-xs-12">
					<div class="box-content">
						...
						<table id="example" class="table table-striped table-bordered display" style="width:100%">
							...
							<c:forEach var="notification" items="${sessionScope.listNotificationAdmin}">
                			<tr>
                			<td><c:out value="${notification.getIdClient()}" /></td>
		                    <td><c:out value="${notification.getDescription()}" /></td>
		                    <td><c:out value="${notification.getDate()}" /></td>
		                    <td><c:out value="${notification.getStatus()}" /></td>
			                <td><a href="../projetserv?id=<c:out value="${user.notification()}" />">Supprimer</a></td>
                			</tr>
                			</c:forEach>
	...
	<form action="../projetserv" method="post">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="addTaskLabel">Ajouter notification</h4>
			</div>
			<div class="modal-body">
				<div class="row">

					<div class="col-md-6">
						<div class="form-group"><label for="frm-1">Information Client</label>
						<select name="idClient" id="frm-1" class="form-control">
						<%
									
										ClientServicesImpl coll1= new ClientServicesImpl();
										List<Client> collalist1=coll1.listClient();
										for(Client b:collalist1)
										{
										%>
