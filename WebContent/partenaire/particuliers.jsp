		...
		<div class="user">
			...
			<div class="control-wrap js__drop_down">
				...
				<div class="control-list">
					<div class="control-item"><a href="profile.jsp"><i class="fa fa-user"></i> Profil</a></div>
	...
	<div class="main-content">
		...
		<ul class="filters">
				...
				<%
							...
							Iterator<Client> list1 = clt.listClient().iterator();
								while(list1.hasNext())
								{
									Client p=list1.next(); 
									if(p.getType().equalsIgnoreCase("Particulier")){
									
								%>
		
			<div class="col-lg-6 col-md-6">
				<div class="box-contact">
				<a href="../profile/profileAdminUser.jsp?email=<%=p.getEmail()%>">
				<%
				if(p.getAvatar().equalsIgnoreCase("vide"))
				{
				%>
				...
				{
				%>
				<img src="../tmpfiles/<%=p.getAvatar()%>" alt="" class="avatar"/>					
				<%} %>					
				</a>
					...
					<div class="text-muted">
						...
						<ul class="contact-social list-inline">
							<li><a href="#" data-toggle="tooltip" data-placement="top" title="" class="fa fa-phone"></a></li>
							<li><a href="../message/messageComposerAdmin.jsp?email=<%=p.getEmail() %>" data-toggle="tooltip" data-placement="top" title="<%=p.getEmail() %>" class="fa fa-envelope"></a></li>
						</ul>
					</div>
				</div>
				<!-- /.box-contact -->
