...
<div id="page-404">
	<div class="content">
		...
		<h1 class="title-on-mobile">Erreur 404 - Page non trouvée</h1>
		<p>On dirait que vous avez peut-être pris un mauvais tournant. Ne t'inquiète pas ... ça arrive aux meilleurs d'entre nous. Vous voudrez peut-être vérifier votre connexion Internet. Voici un petit conseil qui pourrait vous aider à vous remettre sur la bonne voie.</p>
