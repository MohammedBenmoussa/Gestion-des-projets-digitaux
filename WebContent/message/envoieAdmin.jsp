				...
				<div class="box box-solid">
					<div class="box-body">
						<ul class="nav nav-pills nav-stacked">
							<li ><a href="../projetserv?type=messageadmin"><i class="fa fa-inbox"></i>boîte de réception
							<%
							...
							<li class="active"><a href="../projetserv?type=messageadminEnvoie"><i class="fa fa-envelope"></i> Envoyé</a></li>
					...
					<div class="box-body no-padding">
						...
						<div class="table-responsive mailbox-messages">
							...
							for (Mail m : listEmail) {
								if(idSession==m.getEmetteur() && m.getPriviligeEmetteur().equalsIgnoreCase("administrateur")){
								%>
									<tr>
										<td><input type="checkbox" width="10%"></td>
										<td class="mailbox-name" width="20%"><a href="lire-email-client.jsp">Moi </a> ==> <%=m.getPriviligeDistinataire()%></td>
