				...
				<div class="box box-solid">
					<div class="box-body">
						<ul class="nav nav-pills nav-stacked">
							<li><a href="messageClient.jsp"><i class="fa fa-inbox"></i>boîte de réception
							<%
							...
							<li class="active"><a href="../projetserv?type=messageClientEnvoie"><i class="fa fa-envelope"></i> Envoyé</a></li>
