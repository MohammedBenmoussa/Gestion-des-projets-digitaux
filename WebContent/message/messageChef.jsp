				...
				<div class="box box-solid">
					<div class="box-body">
						<ul class="nav nav-pills nav-stacked">
							<li class="active"><a href="messageChef.jsp"><i class="fa fa-inbox"></i>boîte de réception
							<%
							...
							<li><a href="envoieChef.jsp"><i class="fa fa-envelope"></i> Envoyé</a></li>
					...
					<div class="box-body no-padding">
						...
						<div class="table-responsive mailbox-messages">
							...
							for (Mail m : listEmail) {
								if(idSession==m.getDistinataire() && m.getPriviligeEmetteur().equalsIgnoreCase("Chef de projet")==false && m.getPriviligeDistinataire().equalsIgnoreCase("Chef de projet")==true)
								{
								%>
									<tr>
