				...
				<div class="box box-solid">
					<div class="box-body">
						<ul class="nav nav-pills nav-stacked">
							<li ><a href="messageCollaborateur.jsp"><i class="fa fa-inbox"></i>boîte de réception
							<%
							...
							<li class="active"><a href="envoieCollaborateur.jsp"><i class="fa fa-envelope"></i> Envoyé</a></li>
					...
					<div class="box-body no-padding">
						...
						<div class="table-responsive mailbox-messages">
							...
							for (Mail m : listEmail) {
								if(idSession==m.getEmetteur() && m.getPriviligeEmetteur().equalsIgnoreCase("collaborateur")){
								%>
									<tr>
